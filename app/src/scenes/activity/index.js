...
const Activity = () => {
  ...
  // Callback function to update activities in the parent component
  ...
  return (
    ...
    <div className="w-screen md:w-full">
      ...
      {date && user && <Activities date={new Date(date)} user={user} project={project} updateActivities={updateActivities} />}
    </div>
  );
};

const Activities = ({ date, user, project, updateActivities }) => {
  ...
  const updateActivitiesState = (updatedActivities) => {
    setActivities(updatedActivities);

                  ...
                  <div>
                    <div className="flex justify-between flex-wrap">
                      <div className="w-full md:w-[48%] mt-2">
                        ...
                        <ErrorMessage name="name" component="div" className="text-red-500" /> {/* Display error message */}
                      </div>
                      <div className="w-full md:w-[48%] mt-2">
                        ...
                        <ErrorMessage name="email" component="div" className="text-red-500" /> {/* Display error message */}
                      </div>
                    </div>
                    <div className="flex justify-between flex-wrap mt-3">
                      ...
                      <div className="w-full md:w-[48%] mt-2">
                        ...
                        <ErrorMessage name="password" component="div" className="text-red-500" /> {/* Display error message */}
                      </div>
                    </div>
                  </div>
